...
(function () {
    ...
    League.getPlatformId = function (region, callback) { // TODO: add pbe
        var platforms = {
                'na': 'NA1',
                'euw': 'EUW1',
                'eune': 'EUN1',
    ...
    League.Summoner.listSummonerDataByNames = function (names, regionOrFunction, callback) {
        var regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
            url;
