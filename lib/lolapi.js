...
(function () {
	...
	League.getMatchHistory = (accountId, {beginTime, endTime, beginIndex, endIndex, season, championIds, queue}, platformId = platformIdDefault, callback = undefined) => {
		...
		if (season){
			historyOptions += '&season=' + season.join();
		}
		if (championIds) {
			historyOptions += '&champion=' + championIds.join();
		}
		if (queue) {
			historyOptions += '&queue=' + queue.join();
		}
    ...
    League.Static.getChampionList = function(options, regionOrFunction, callback) {
        var championListUrl = '/v1.2/champion?', // TODO: replace with definition of urls on top of file
            regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
            url;
        if(options) {
    ...
    League.Static.getChampionById = function(id, options, regionOrFunction, callback) {
        var championListUrl = '/v1.2/champion/' + id + '?', // TODO: replace with definition of urls on top of file
            regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
            url;
    ...
    League.Static.getItemList = function(options, regionOrFunction, callback) {
        var itemListUrl = '/v1.2/item?', // TODO: replace with definition of urls on top of file
            regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
            url;
        if (options) {
    ...
    League.Static.getItemById = function(id, options, regionOrFunction, callback) {
        var itemListUrl = '/v1.2/item/' + id + '?', // TODO: replace with definition of urls on top of file
            regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
            url;
        if (options) {
            if (options.itemData) {
    ...
    League.Static.getMasteryList = function(options, regionOrFunction, callback) {
        var masteryListUrl = '/v1.2/mastery?', // TODO: replace with definition of urls on top of file
            regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
            url;
        if (options) {
    ...
    League.Static.getMasteryById = function(id, options, regionOrFunction, callback) {
        var masteryIdUrl = '/v1.2/mastery/' + id + '?', // TODO: replace with definition of urls on top of file
            regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
            url;
        if (options) {
    ...
    League.Static.getRuneList = function(options, regionOrFunction, callback) {
        var runeListUrl = '/v1.2/rune?', // TODO: replace with definition of urls on top of file
            regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
            url;
        if (options) {
    ...
    League.Static.getRuneById= function(id, options, regionOrFunction, callback) {
        var runeListUrl = '/v1.2/rune/' + id + '?', // TODO: replace with definition of urls on top of file
            regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
            url;
        if (options) {
            if (options.runeData) {
    ...
    League.Static.getSummonerSpellList = function(options, regionOrFunction, callback) {
        var summonerSpellUrl = '/v1.2/summoner-spell?', // TODO: replace with definition of urls on top of file
            regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
            url;
        if (options) {
    ...
    League.Static.getSummonerSpellById = function(id, options, regionOrFunction, callback) {
        var summonerSpellUrl = '/v1.2/summoner-spell/' + id + '?', // TODO: replace with definition of urls on top of file
            regionAndFunc = util.getCallbackAndRegion(regionOrFunction, region, callback),
            url;
        if (options) {
            if (options.spellData) {
