...
class MatchEndpoint extends Endpoint {
	 ...
	 * @param options
	 * @param options.forAccountId If provided, used to identify the participant to be unobfuscated (needed for non-ranked matches).
		...
		return Bluebird.resolve()
			.then(() => {
				...
				if (options.forAccountId){
					return ErrorUtil.throwIfNotNumerical(options.forAccountId);
				}
			})
