...
class DataDragonHelper {
	...
	static gettingLanguages() {
		return requestingCached(DataDragonHelper.URL_DDRAGON_LANGUAGES);
	}
	 ...
	 * @param ddV
	 * @param locale
	 * @return {ChampionListDTO & {"format": "full"}}
	 */
	static gettingFullChampionsList(ddV, locale) {
		return /** @type ChampionListDTO & {"format": "full"} */ gettingLocalList(ddV, 'championFull', locale);
	}
	 ...
	 * @param ddV
	 * @param locale
	 * @return {ListDTO<ChampionDTO> & {"format": "standAloneComplex"}}
	 */
	 ...
	 * @param ddV
	 * @param locale
	 * @returns {ListDTO<SummonerSpellDTO>} keys = spell key
	 */
	 ...
	 * @param ddV
	 * @param locale
	 * @returns {ListDTO<ProfileIconDTO>} keys = id
	 */
	static gettingProfileiconList(ddV, locale) {
		return /** @type ListDTO<ProfileIconDTO> */ gettingLocalList(ddV, 'profileicon', locale);
	}
	 ...
	 * @returns {ListDTO<MapDTO>}
	 * */
	static gettingMaps(ddV, locale) {
		const [major, minor, patch] = ddV.match(/\d+/g).map(s => parseInt(s));
		...
		return gettingLocalList(ddV, 'map', locale);
	}
