 ...
 *Generally, only "data" is returned.
 * In case of 'mastery' though, the return value will consist of {data, tree}. // TODO: normalize to send the whole object as is? + fixing the runesReforged ones?
 * @param version
...
function downloadingStaticDataFiles(locale, version) {
	...
	/** removed with 7.24	 */
	const runesUri = `${DataDragonHelper.URL_DDRAGON_CDN}/${version}/data/${locale}/rune.json`;
	const masteriesUri = `${DataDragonHelper.URL_DDRAGON_CDN}/${version}/data/${locale}/mastery.json`;
