...
var https = require('https'),
    ...
    craftUrlV3 = function (apiUrl, authKey, queryString = '?') {
		return `${apiUrl}${queryString}api_key=${authKey}`;
	},
    ...
    getValidSeasonParam = function (season) {
    	// TODO: rename getIsValidSeasonParam
        // TODO: add new Season params
    ...
    getCallbackAndRegion = function (regionOrFunction, region, callback) {
        var regionAndFunction = {
            'region': region, // TODO: rename and refactor to platform
            'callback': callback
        };
